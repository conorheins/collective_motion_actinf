...
def run(
        ...
        average_sw=2.0, # the average sensory smoothness across all agents
    ...
    s_w_all = random.uniform(smoothness_key, minval = average_sw-0.25, maxval = average_sw+0.25, shape = (N,)) # sample a different sensory smoothness for every agent
    ...
    if save:
        ...
        position_history, sz_history = simulation_history[0], simulation_history[1]['s_w']
        ...
        axes[1].set_ylabel('Learned beliefs about $s_w$ over time')
