...
def step_fn(carry, t):
    ...
    return (pos, vel, mu, preparams), (pos, vel, mu, preparams['f_params_pre']['alpha'], F)
...
# axes[1].plot(jnp.arange(0, len(genproc['t_axis'])),alpha_hist[:,good_fish_ids])
